...
@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Tambah Pendidikan</h1>
    <p class="text-gray-600 dark:text-gray-400">Tambahkan riwayat pendidikan baru</p>
</div>
    ...
    <form method="POST" action="{{ route('admin.education.store') }}">
        ...
        <div class="flex justify-end space-x-4 mt-8">
            ...
            <button type="submit" 
                ...
                <i class="bi bi-check-lg mr-2"></i>Simpan Pendidikan
            </button>
        </div>
    </form>
</div>
